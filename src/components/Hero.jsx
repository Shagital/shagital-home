...
const Hero = () => {
  return (
    <div className='text-center text-white py-7 md:py-14'>
        <h1 className='text-[30px] leading-normal lg:leading-16 md:leading-14 md:text-5xl font-extrabold bg-gradient-to-br from-[#FFEED0] to-[#DC8B00] bg-clip-text text-transparent'>
            <span className='underline text-[#FFEED0]'>SHAGITAL</span> IS A NIGERIAN <br />BASED TECHNOLOGY <br /> COMPANY
        </h1>
        <p className='text-[18px] md:text-xl mt-2 md:mt-4 leading-relaxed mx-5 font-light'>
        ...
        <div className='mt-5 md:mt-7 flex text-center justify-center gap-3 md:gap-6'>
            <a href='#project' className='px-4 py-3 border border-[#DC8B00] rounded-full text-sm md:text-lg cursor-pointer hover:bg-[#DC8B00] transition duration-500 hover:text-white text-[16px]'>VIEW PROJECTS</a>
            <a href='#contact' className='px-4 py-3 text-[16px] bg-[#DC8B00] rounded-full text-sm md:text-lg cursor-pointer hover:bg-[#dc7900] transition duration-500 hover:text-white'>CONTACT US</a>
        </div>
    </div>
  )
}
