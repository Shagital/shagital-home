  ...
  return (
    <div className='text-center text-white py-7 md:py-14'>
        ...
        <div className='mt-5 md:mt-7 flex text-center justify-center gap-3 md:gap-6'>
            <button className='px-3 py-2 border border-[#DC8B00] rounded-full text-xs cursor-pointer hover:bg-[#DC8B00] transition duration-500 hover:text-white'>VIEW PROJECTS</button>
            <button className='px-3 py-2 bg-[#DC8B00] rounded-full text-xs cursor-pointer hover:bg-[#dc7900] transition duration-500 hover:text-white'>CONTACT US</button>
        </div>
    </div>
  )
}
